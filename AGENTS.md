...
- Before a page or lab PR: `python3 scripts/shed_check.py` (runs cook_guard, page56 lab, unit lab, Ensure-TweetCard, precache check; no new locators, no secrets, no solve claims).
