...
- Before a page or lab PR: `python3 scripts/shed_check.py` (runs cook_guard, page56 lab, unit lab, tweet card, precache, headers, listing, page-lab contract, door check; no new locators, no secrets, no solve claims).
