...
#   - cook_guard, page56 lab, unit lab, Ensure-TweetCard, precache, or headers check no longer hold
...
def main() -> int:
    ...
    if fails:
        ...
        return 1
    print("SHED CHECK OK")
    print("public school holds: cook guard, page56 lab, unit lab, tweet card, precache, headers,")
