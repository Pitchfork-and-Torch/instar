...
After visual or hello copy: bump `og.jpg?v=`, then `python3 scripts/ensure_tweet_card.py`. Hits slug stays `instar`. After `public/llms.txt`: `python3 scripts/llms_check.py`.
